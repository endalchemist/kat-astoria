...
public class CreateLevelOneItem : MonoBehaviour {
    ...
    private string[] weaponNames = new string[29] {"Greatsword","Greataxe","Maul","Axe","Halberd","Polearm","Short Sword","Long Sword","Bow","Crossbow","Gun","Dagger","Fists","Mace","Staff","Quarterstaff","Wand","Tome","Hoe","Crafters Maul","Crafters Hammer", "Woodsmans Axe", "Shovel","Pickaxe","Tinkers Tools", "Shield" };
